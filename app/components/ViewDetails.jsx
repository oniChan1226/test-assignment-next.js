...
const ViewDetails = ({ checkin, onClose, onUpdate }) => {
  const [rooms, setRooms] = useState(checkin.rooms || 0);
  const [guest, setGuest] = useState(checkin.guest || 0);
